...
const [authUser,setAuthUser]=useAuth();
  ...
  return (
    <>
    <div className={`dark:bg-slate-900 dark:text-white max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-[100] ${
      stick
      ?"dark:bg-slate-900 dark:text-white sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out z-[100] "
      :""
    }`}>
...
</label>
{
  ...
  <a className="px-3 py-2  rounded-md bg-slate-800 duration-300 cursor-pointer text-white" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
  <Login/>
</div>
}
